	...
	<div class="container">
		<div class="row">
			<form:form class="form-horizontal" action="" method="post"
				modelAttribute="entreprise" style="width: 50%; margin: auto;">
				<fieldset>
					...
					<div class="form-group">
						...
						<form:input id="nomEntreprise" name="nomEntreprise" type="text"
							class="form-control input-md" required="" path="nomEntreprise"  />
