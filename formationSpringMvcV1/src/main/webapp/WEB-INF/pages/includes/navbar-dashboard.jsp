	...
	<div class="sidebar-content">
		...
		<div class="sidebar-header">
			<div class="user-pic">
				<img class="img-responsive img-rounded"
					src="<c:url value="/resources/images/logo9.png" />"
					alt="User picture">
			</div>
			<div class="user-info">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="<c:url value='/profil/liste/'/>"> <i
						class="far fa-gem"></i> <span>Liste</span>
				</a></li>
				<li><a href="<c:url value='/profil/grade/'/>"> <i
						class="fa fa-chart-line"></i> <span>Stratégie Réseau</span>
				</a></li>
				<li ><a href="<c:url value='/profil/support/'/>"> <i
