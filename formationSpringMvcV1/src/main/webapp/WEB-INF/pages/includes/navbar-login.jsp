...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" ml-auto>	<a class="navbar-brand" href="<c:url value='/article/accueil/'/>" ml-auto><img alt="" src="<c:url value="/resources/images/logo7.png" />"  style="width: 70px;"></a>
